...
export type ContentMessagesType = {
  ...
  /** Email OTP — step 1 submit */
  emailSendOtp: string;
  emailOtpSent: string;
  emailVerifyOtp: string;
  emailResendOtp: string;
  emailOtpWrong: string;
  /** Label before mm:ss countdown */
  emailOtpExpiresIn: string;
  emailOtpHint: string;
...
export const contentMessages: Record<ContentLocale, ContentMessagesType> = {
  ro: {
    ...
    emailNoPasswordNeeded: "Îți trimitem un cod de 6 cifre pe email.",
    emailLinkSent: "✓ Cod trimis — verifică email-ul",
    emailSendOtp: "Trimite cod",
    emailOtpSent: "Ți-am trimis un cod de 6 cifre.",
    emailVerifyOtp: "Verifică codul",
    emailResendOtp: "Retrimite codul",
    emailOtpWrong: "Cod incorect sau expirat",
    emailOtpExpiresIn: "Expiră în",
    emailOtpHint: "Introdu codul din email",
  ...
  en: {
    ...
    loginWithEmail: "Email (OTP code)",
    loginWithReddit: "Continue with Reddit",
    loginWithPhone: "Phone number (OTP)",
    emailPlaceholder: "email@example.com",
    emailProceed: "Proceed",
    emailNoPasswordNeeded: "We'll email you a 6-digit code.",
    emailLinkSent: "✓ Code sent — check your email",
    emailSendOtp: "Send code",
    emailOtpSent: "We sent a 6-digit code to your email.",
    emailVerifyOtp: "Verify code",
    emailResendOtp: "Resend code",
    emailOtpWrong: "Invalid or expired code",
    emailOtpExpiresIn: "Expires in",
    emailOtpHint: "Enter the code from your email",
  ...
  de: {
    ...
    loginWithEmail: "E-Mail (OTP code)",
  ...
  tr: {
    ...
    loginWithEmail: "E-posta (OTP code)",
